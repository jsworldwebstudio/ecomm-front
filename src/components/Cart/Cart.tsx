...
const Cart: FC = () => {
  ...
  return (
    ...
    >
          ...
          cartItems.map((item) => (
            <div key={item._id} className={cartItemClassNames.container}>
              ...
              <div className={cartItemClassNames.quantityContainer}>
                ...
                <button className={cartItemClassNames.removeButton} onClick={() => handleRemoveItem(item._id)}>
                  <RiCloseLine />
                </button>
              </div>
            </div>
      ...
      <button className={classNames.checkoutBtn} onClick={checkoutHandler}>Checkout</button>
    </div>
  );
};
